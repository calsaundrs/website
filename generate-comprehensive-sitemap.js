...
async function generateComprehensiveSitemap() {
  ...
  const staticPages = [
    ...
    { url: '/clubs.html', changefreq: 'monthly', priority: '0.7' },
    { url: '/birmingham-pride.html', changefreq: 'monthly', priority: '0.7' },
    ...
    { url: '/promoter-submit.html', changefreq: 'monthly', priority: '0.6' },
