                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="venue-card p-6">
                            <a href="{{event.details.link}}" target="_blank" rel="noopener noreferrer" class="btn-primary text-white w-full min-w-full block py-3 px-6 rounded-lg font-bold flex items-center justify-center">
