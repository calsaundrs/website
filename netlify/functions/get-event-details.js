...
<body>
    ...
    <main class="w-full bg-[#050505] min-h-screen">
        ...
        <!-- Top Poster Section: Elegant Display, No Cropping -->
        <div class="w-full relative h-[60vh] md:h-[80vh] bg-[#020202] flex items-center justify-center pt-8 pb-16 px-4 border-b border-white/5">
            {{#if event.image}}
        ...
        <div class="max-w-[1400px] mx-auto w-full flex flex-col relative z-20">
            
            <!-- Breadcrumbs / Top alignment -->
            <nav class="w-full px-6 py-6 flex items-center justify-between text-xs font-medium uppercase tracking-[0.2em] text-white/50 border-b border-white/10 bg-[#050505]">
            ...
            <!-- Massive Title Block -->
            <div class="w-full px-6 py-16 md:py-32 border-b border-white/10 bg-[#050505]">
                <h1 class="text-white font-black text-5xl sm:text-7xl md:text-8xl lg:text-9xl uppercase leading-[0.8] tracking-[-0.04em] m-0 font-display break-words max-w-[1200px]">
                    {{event.name}}
                </h1>
                
                <!-- Auxiliary Tags -->
                <div class="flex flex-wrap gap-3 mt-12 opacity-80">
                    {{#each event.category}}
                    <span class="text-white border border-white/20 px-4 py-2 font-bold text-[10px] sm:text-xs uppercase tracking-[0.25em]">{{this}}</span>
                    {{/each}}
                    {{#if event.ageRestriction}}
                    <span class="text-[var(--color-toxic)] border border-[var(--color-toxic)] px-4 py-2 font-bold text-[10px] sm:text-xs uppercase tracking-[0.25em]">{{event.ageRestriction}}</span>
                    {{/if}}
                </div>
            </div>
