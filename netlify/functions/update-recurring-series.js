                ...
                console.log(`update-recurring-series: Deleted ${deleteIds.length} existing future instances`);
                    ...
                    if (instanceRecords.length > 0) {
                        ...
                        for (let i = 0; i < instanceRecords.length; i += batchSize) {
                            ...
                            console.log(`update-recurring-series: Created batch ${Math.floor(i/batchSize) + 1} with ${batch.length} instances`);
                        }
                        
                        console.log(`update-recurring-series: Created ${totalCreated} total new instances`);
                    }
                }
            } catch (instanceError) {
