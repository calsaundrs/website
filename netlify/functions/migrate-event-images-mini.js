...
exports.handler = async (event, context) => {
  try {
    console.log('Starting mini event image migration...');
    ...
    console.log('Mini migration completed');
    ...
    return {
      ...
      body: JSON.stringify({ 
        success: true,
        message: 'Mini event image migration completed',
