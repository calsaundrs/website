...
exports.handler = async function (event, context) {
    console.log('Minimal event submission handler called');
    ...
    try {
        ...
        // Prepare minimal event data for Airtable (only essential fields)
        const eventData = {
        ...
        console.error('Minimal event submission failed:', error);
        return {
            statusCode: 500,
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
