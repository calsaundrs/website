...
exports.handler = async function(event, context) {
  try {
    ...
    // CTR-optimised for actual GSC search queries (Apr 2026 audit)
    const venueMetaOverrides = {
      'the-fox': {
        metaTitle: 'The Fox Birmingham | Reviews, Photos & What\u2019s On | Brum Outloud',
        metaDescription: 'The Fox is Birmingham\u2019s cosiest gay bar on Lower Essex Street. See reviews, photos, what\u2019s on this week \u2014 karaoke Fridays, acoustic Saturdays, drag Sundays.'
      },
      'the-nightingale-club': {
        metaTitle: 'Nightingale Club Birmingham | Reviews, Photos & Upcoming Events | Brum Outloud',
        metaDescription: "Birmingham\u2019s iconic LGBTQ+ superclub on Kent Street. Two floors, multiple bars, huge capacity. See what\u2019s on \u2014 POUNDED Thursdays, Big Saturgay. Open Thu\u2013Sat."
      },
      'equator-bar': {
        metaTitle: 'Equator Bar Birmingham | Reviews, Photos & What\u2019s On | Brum Outloud',
        metaDescription: "Equator Bar is a relaxed LGBTQ+ bar on Hurst Street, open 20+ years. Coffee by day, cocktails by night. See reviews, photos and upcoming events."
      },
      'missing-bar': {
        metaTitle: 'Missing Bar Birmingham | Reviews, Photos & What\u2019s On | Brum Outloud',
        metaDescription: "Missing Bar is Birmingham\u2019s late-night party bar in the Gay Village. Open till 4am Fri\u2013Sat. See reviews, photos, upcoming drag shows and events."
      },
      'eden-bar': {
        metaTitle: 'Eden Bar Birmingham | Reviews, Photos & What\u2019s On | Brum Outloud',
        metaDescription: "Gooch Street\u2019s award-winning LGBTQ+ cabaret bar. Two floors, terrace and live shows from across the UK. See reviews, photos and what\u2019s on."
      },
      'glamorous': {
        metaTitle: 'Glamorous Birmingham | Reviews, Photos & What\u2019s On | Brum Outloud',
        metaDescription: "Hurst Street\u2019s late-night LGBTQ+ nightclub, open until 6am. Renovated in 2025 with new management. See reviews, photos and upcoming events."
      },
      'the-village-inn': {
        metaTitle: 'The Village Inn Birmingham | Reviews, Photos & What\u2019s On | Brum Outloud',
        metaDescription: "The beating heart of Birmingham\u2019s Gay Village. Cabaret bar with drag and live entertainment seven nights a week. See reviews, photos and what\u2019s on."
      },
      'the-fountain-inn': {
        metaTitle: 'The Fountain Inn Birmingham | Reviews, Photos & What\u2019s On | Brum Outloud',
        metaDescription: "One of Birmingham\u2019s most beloved traditional gay pubs on Wrentham Street. Welcoming and affordable. See reviews, photos and upcoming events."
      },
      'the-loft': {
    ...
    const templateData = {
      ...
      shareUrl: `https://www.brumoutloud.co.uk/venue/${slug}`,
...
async function getVenueBySlug(slug) {
  try {
    ...
    const allVenues = await withRetry(() => venuesRef.get(), { label: 'Firestore venues query' });
    let foundVenue = null;
